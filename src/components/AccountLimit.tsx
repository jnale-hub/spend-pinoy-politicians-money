...
const AccountLimit = () => {
  ...
  return (
    <div className="my-4 sticky top-0">
      <div className="relative w-full h-20 bg-slate-300 overflow-hidden rounded-full">
        <div
          className="absolute top-0 left-0 h-full bg-gradient-to-b from-orange-500 to-orange-600 transition-all duration-1000 ease-out"
          style={{ width: `${remainingPercentage}%` }}
        ></div>
        <div className="relative z-10 text-slate-50 p-6 text-4xl font-bold text-center">
          <animated.span>
            {number.to((n) =>
